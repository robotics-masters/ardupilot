...
bool AP_Baro_BME280::_init()
{
    ...
    _dev->write_register((BME280_REG_CONFIG & mask), BME280_FILTER_COEFFICIENT << 2, true);

    _instance = _frontend.register_sensor();

    // request 50Hz update
    _dev->register_periodic_callback(20 * AP_USEC_PER_MSEC, FUNCTOR_BIND_MEMBER(&AP_Baro_BME280::_timer, void));
